...
import net.mcreator.jujutsucraftaddon.network.AltarMessageKashimo;
...
public class KashimoScreen extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<KashimoScreen.AltarOption> options = this.getOptions();
    ...
    private List<KashimoScreen.AltarOption> getOptions() {
        List<KashimoScreen.AltarOption> options = new ArrayList<>();
        options.add(new KashimoScreen.AltarOption("Strong Attack"));
        options.add(new KashimoScreen.AltarOption("Speed Blitz"));
        options.add(new KashimoScreen.AltarOption("Kaminari Strike"));
        options.add(new KashimoScreen.AltarOption("Lightning Barrage"));
        options.add(new KashimoScreen.AltarOption("Lightning Strike"));
        options.add(new KashimoScreen.AltarOption("Turn Up The Volume"));
        options.add(new KashimoScreen.AltarOption("Mythical Beast Amber"));
        options.add(new KashimoScreen.AltarOption("Domain Expansion"));
        return options;
    }
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            KashimoScreen.AltarOption item = this.getCurrent().get(i);
            int white = toRGB24(255, 255, 255, 150);
            int black = toRGB24(255, 68, 218, 150);
            ...
            if (this.hovered > 0) {
                ...
                AltarMessageKashimo.pressAction(Minecraft.getInstance().player, this.hovered);
    ...
    private List<? extends KashimoScreen.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends KashimoScreen.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        KashimoScreen.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
